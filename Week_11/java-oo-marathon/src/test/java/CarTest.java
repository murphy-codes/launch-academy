...
public class CarTest {
  ...
  public void setupCar(){
    this.car = new Car("hatchback", "Elantra", "Hyundai", 31, 11, false, 5, 2);
    this.simpleCar = new Car("hatchback", "Electra", "Hyundai", 31, 11, 5, 2);
  }

  @Test
  @DisplayName("When initialized a car has a type")
  public void init_car_hasType(){
    Assertions.assertEquals("hatchback", this.car.getType());
  }

  @Test
  @DisplayName("When initialized a car has a model")
  public void init_car_hasModel(){
    Assertions.assertEquals("Elantra", this.car.getModel());
  }

  @Test
  @DisplayName("When initialized a car has a make")
  public void init_car_hasMake(){
    Assertions.assertEquals("Hyundai", this.car.getMake());
  }

  @Test
  @DisplayName("When initialized a car has a mpg")
  public void init_car_hasMpg(){
    Assertions.assertEquals(31, this.car.getMpg());
  }

  @Test
  @DisplayName("When initialized a car has a fuelCapacity")
  public void init_car_hasFuelCapacity(){
    Assertions.assertEquals(11, this.car.getFuelCapacity());
  }

  @Test
  @DisplayName("When initialized a car is running or not running")
  public void init_car_runningTrue(){
    Assertions.assertEquals(false, this.car.getRunning());
  }
  ...
  public void addPassengers_cannot_load_past_capacity(){
    this.car.addPassengers(5);
    Assertions.assertEquals(2, this.car.getNumPassengers());
  }

  @Test
  @DisplayName("addPassengers cannot load past capacity")
  public void addPassengers_cannot_load_past_capacity_return(){ Assertions.assertEquals(false, this.car.addPassengers(5)); }
